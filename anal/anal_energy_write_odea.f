...
c    energy        ==> Total energy
      ...
      subroutine anal_energy_write_odea(t, nbod, umat, mass, xj, yj, zj,
     &     vxj, vyj, vzj, iu, fopenstat, diro, eoff, energy, dt)

      include '../swift.inc'

c...  Inputs:
      integer nbod, iu
      real*8 mass(nbod), t, umat(NPLMAX,NPLMAX), eoff, dt
...
c...  Executable code
     ...
     &   xb, yb, zb, vxb, vyb, vzb)
      ...
      call io_energy_write_odea(i1st, t, energy, eltot, dt, iu, diro,
     &   fopenstat)
