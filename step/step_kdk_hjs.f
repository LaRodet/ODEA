...
c    vxjt, vyjt, vzjt ==>  final position in gen. Jacobi coord
      ...
      subroutine step_kdk_hjs(i1st, time, nbod, ntp, oloc, oloct, mat,
     &   umat, matp, umatp, mass, eta, mu, etatp, xj, yj, zj, vxj, vyj,
...
c...     Next the test particles
         call step_kdk_tp_hjs(i1sttp, nbod, ntp, matp, umatp, oloct,
     &      mass, eta, mu, etatp, xjbeg, yjbeg, zjbeg, vxjbeg, vyjbeg,
     &      vzjbeg, ir3jbeg, xbbeg, ybbeg, zbbeg, axbbeg, aybbeg,
     &      azbbeg, vxjh, vyjh, vzjh, xjend, yjend, zjend, ir3jend,
     &      xbend, ybend, zbend, axbend, aybend, azbend,
     &      xjt, yjt, zjt, vxjt, vyjt, vzjt, istat, dt, time)
